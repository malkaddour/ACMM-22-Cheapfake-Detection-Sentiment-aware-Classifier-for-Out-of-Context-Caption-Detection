...
#BASE_DIR = '/hdd3/malkaddour/datasets/cheapfakes/2021-grandchallenge-cheapfakes-cosmosonsteroids/'

#BASE_DIR = os.getenv("COSMOS_BASE_DIR")
#DATA_DIR = '/hdd3/malkaddour/datasets/cheapfakes/data/'
#TARGET_DIR = BASE_DIR + '/viz/'

#TARGET_DIR = os.getenv("COSMOS_TARGET_DIR") or f'{BASE_DIR}/viz'
BASE_DIR = os.getenv("COSMOS_BASE_DIR")
DATA_DIR = os.getenv("COSMOS_DATA_DIR") or f'{BASE_DIR}/data'
#DATA_DIR = os.path.join(BASE_DIR, os.getenv("COSMOS_DATA_DIR"))
#DATA_DIR = os.path.join(BASE_DIR, )
TARGET_DIR = os.getenv("COSMOS_TARGET_DIR") or f'{BASE_DIR}/viz'
#DATA_DIR = '/hdd3/malkaddour/datasets/cheapfakes/data/'
#BASE_DIR = '/hdd3/malkaddour/datasets/cheapfakes/newdockersubmission/'
# Word Embeddings
